...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var calcRes = {};
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])("#size", "#material", "#options", ".promocode", ".calc-price", calcRes);
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(calcRes);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promocode, result, calcRes) {
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var tmp = input.files[0].name.split('.');
      tmp[0].length > 11 ? dots = "..." : dots = ".";
      var name = tmp[0].substring(0, 11) + dots + tmp[1];
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (target && target.tagName == "LI") {
      ...
      markType = wrapper.querySelectorAll('.' + className);
    }
...
var forms = function forms(state) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      var dots;
      var tmp = item.files[0].name.split('.');
      tmp[0].length > 11 ? dots = "..." : dots = ".";
      var name = tmp[0].substring(0, 11) + dots + tmp[1];
    ...
    item.addEventListener("submit", function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        if (state) {
          ...
          var resultBlock = document.querySelector(".calc-price");
...
var giftTrigger = document.querySelector('.fixed-gift');
...
function closeModal(selector) {
  ...
  giftTrigger.style.right = ''; //document.body.classList.remove("modal-open"); // use class from bootstrap.css
}
...
var modals = function modals() {
  ...
  function openModal(selector) {
    ...
    btnPressed = true; //document.body.classList.add("modal-open"); // use class from bootstrap.css
  ...
  showModalByScroll();
  var timerId = showModalByTime(".popup-consultation", 60000);
};
...
var scrolling = function scrolling(upSelector) {
  ...
  window.addEventListener("scroll", function (upSelector) {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('animated', 'flipInX', 'col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    ...
    console.log("No button arguments");
  }
